...
Required fields: name, email, password (temporary), phone, class,school
...
Required columns:  name, email, password (temporary), phone, class,school,parent name, parent phone, joined date
